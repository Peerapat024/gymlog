  ...
  const screens = [
    ...
    <div key="welcome" style={{ animation: anim, display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 36px' }}>
        <div style={{ fontSize: 13, color: '#4c6a15', letterSpacing: '0.25em', fontWeight: 700, marginBottom: 16 }}>WELCOME TO</div>
        ...
        <div style={{ fontSize: 16, color: '#777', lineHeight: 1.6, fontWeight: 500 }}>Your personal training log.<br />No account. No cloud. Just you and your weights.</div>
      </div>
    ...
    <div key="name" style={{ animation: anim, display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 36px' }}>
        <div style={{ fontSize: 13, color: '#777', letterSpacing: '0.15em', fontWeight: 700, marginBottom: 12 }}>STEP 1 OF 2</div>
        ...
        <div style={{ fontSize: 14, color: '#666', marginBottom: 36, lineHeight: 1.6 }}>Optional — we'll personalise your session summaries.</div>
      ...
      <div style={{ margin: '0 24px' }}>
        <div style={{ display: 'flex', gap: 10 }}>
          <button onClick={() => { haptic.light(); goTo(0); }} style={{ padding: '18px 20px', background: 'transparent', border: '0.5px solid #2a2a2a', borderRadius: 12, fontSize: 14, fontWeight: 700, cursor: 'pointer', color: '#777' }}>←</button>
    ...
    <div key="bw" style={{ animation: anim, display: 'flex', flexDirection: 'column', height: '100%' }}>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '0 36px' }}>
        <div style={{ fontSize: 13, color: '#777', letterSpacing: '0.15em', fontWeight: 700, marginBottom: 12 }}>STEP 2 OF 2</div>
        ...
        <div style={{ fontSize: 14, color: '#666', marginBottom: 32, lineHeight: 1.6 }}>Used for bodyweight exercises like pull-ups and dips. You can update this anytime in CONFIG.</div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <span style={{ fontSize: 24, fontWeight: 700, color: '#555' }}>{unit.toUpperCase()}</span>
        </div>
        <div style={{ marginTop: 12, fontSize: 13, color: '#555', letterSpacing: '0.04em' }}>This also sets your default weight unit across the app.</div>
      </div>
      <Progress total={3} current={2} />
      <div style={{ margin: '0 24px' }}>
        <div style={{ display: 'flex', gap: 10 }}>
          <button onClick={() => { haptic.light(); goTo(1); }} style={{ padding: '18px 20px', background: 'transparent', border: '0.5px solid #2a2a2a', borderRadius: 12, fontSize: 14, fontWeight: 700, cursor: 'pointer', color: '#777' }}>←</button>
